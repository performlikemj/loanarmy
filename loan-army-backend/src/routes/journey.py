...
Legacy fallback: LoanedPlayer records (for players not yet synced).
"""
from flask import Blueprint, request, jsonify
from src.models.league import db, LoanedPlayer, Team, TeamProfile
...
def get_player_journey(player_id):
    ...
    falls back to LoanedPlayer-based builder for unsynced players.
    ...
    # Fallback: build from LoanedPlayer records
...
# =============================================================================
# Helper: LoanedPlayer-based (legacy fallback)
# =============================================================================
...
def _build_legacy_journey(player_id: int, primary_team_id: int = None) -> dict:
    """Build journey from LoanedPlayer records (legacy fallback).
