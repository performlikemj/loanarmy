                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="grid grid-cols-3 gap-2 text-center">
                                                <div className="bg-gray-50 rounded p-1.5">
                                                    <div className="text-sm font-bold">{node.stats.apps}</div>
                                                    <div className="text-[10px] text-gray-500">Apps</div>
                                                </div>
                                                <div className="bg-gray-50 rounded p-1.5">
                                                    <div className="text-sm font-bold text-blue-600">{node.stats.goals}</div>
                                                    <div className="text-[10px] text-gray-500">Goals</div>
                                                </div>
                                                <div className="bg-gray-50 rounded p-1.5">
                                                    <div className="text-sm font-bold text-green-600">{node.stats.assists}</div>
