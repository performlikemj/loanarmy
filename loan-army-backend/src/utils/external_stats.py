...
def fetch_external_stats(
    ...
    try:
        ...
        # We reuse BraveLoanCollection logic or just use the underlying search function if available.
        # Since BraveLoanCollection is for loans, we might need a simpler search wrapper.
        ...
        # If search_brave isn't directly exposed, we might need to instantiate the client like in brave_loans.py
        # Let's check how brave_loans.py does it.
