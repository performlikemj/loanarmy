...
def convert_newsletter_to_markdown(
    ...
    lines.append('---')
    lines.append('')
    lines.append('*Generated by [The Academy Watch](https://goonloan.com) — Weekly loan watch newsletters for football fans*')
...
def convert_newsletter_to_compact_markdown(newsletter: dict) -> str:
    ...
    lines.append('---')
    lines.append('*via [The Academy Watch](https://goonloan.com)*')
